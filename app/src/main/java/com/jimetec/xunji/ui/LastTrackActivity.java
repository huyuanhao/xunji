...
import com.jimetec.xunji.presenter.LastTrackPresenter;
...
public class LastTrackActivity extends AbsCommonActivity<LastTrackPresenter> implements LastTrackContract.View {
    ...
    @Override
    public LastTrackPresenter getPresenter() {
        return new LastTrackPresenter(this);
    }

    @Override
    public int getLayoutId() {
        return R.layout.activity_last_track;
    }
...
//            }
    ...
    @OnClick({R.id.rlTitleLeft, R.id.ivReview, R.id.tvDeal, R.id.flStart, R.id.flEnd, R.id.btTrackBack, R.id.btPlay})
