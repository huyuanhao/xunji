...
import com.fanjun.keeplive.LogUtil;
...
public final class JobHandlerService extends JobService {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.e("live","local Job  onStartCommand");
        LogUtil.input2File(getApplication(),"local Job  onStartCommand");
    ...
    public boolean onStartJob(JobParameters jobParameters) {
        LogUtil.input2File(getApplication(),"local Job  onStartJob");
        Log.e("live","local  onStartJob");
    ...
    public boolean onStopJob(JobParameters jobParameters) {
        LogUtil.input2File(getApplication(),"local Job  onStopJob");

        Log.e("live","local  onStopJob");
