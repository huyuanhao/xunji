 ...
 * 描述:
 */
public abstract class AbsLoadActivity<T extends BasePresenter> extends AbsCommonActivity<T> implements IBaseView {
    ...
    public ResultStatus mCurrentState = ResultStatus.UNDO;     //   当前状态
    public int mEmptyResId;
    public int mLoadingResId;
    public int mErrorResId;
    int mBase_view = R.id.base_view;
...
//        if (baseView == null)
        baseView = findViewById(mBase_view);
        if (baseView == null) {
            throw new IllegalStateException(
                    "BaseLoadActivity 必须含有命名为'base_view'的View");
        }
